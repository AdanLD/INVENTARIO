                ...
                //Diccionario que almacena dos strings, el nombre del atributo y su remplazo del header (Adan).
{
            ...
            cmb_Buscar_FormDirecciones.DisplayMember = "Value";
            cmb_Buscar_FormDirecciones.ValueMember = "Key";
            cmb_Buscar_FormDirecciones.DataSource = new BindingSource(headersAlmacen, null);
        }
                ...
                //Diccionario que almacena dos strings, el nombre del atributo y su remplazo del header (Adan).
{
        ...
        private void iconButton_Buscar_FormDirecciones_Click(object sender, EventArgs e)
        {
            try
            {
                if (cmb_Buscar_FormDirecciones.SelectedItem == null)
                {
                ...
                string columna = cmb_Buscar_FormDirecciones.SelectedValue.ToString();

                string texto = txt_Buscar_FormDirecciones.Text.Trim();

                string query = "SELECT * FROM TB_Direccion";
        ...
        private void iconButton_Restablecer_FormDirecciones_Click(object sender, EventArgs e)
        {
            try
            {
